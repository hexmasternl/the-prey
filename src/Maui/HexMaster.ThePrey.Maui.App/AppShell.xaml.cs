...
namespace HexMaster.ThePrey.Maui.App
{
    public partial class AppShell : Shell
    {
        public AppShell()
        {
            ...
            // Role-specific gameplay pages the router hands off to.
            ...
            // The post-game conclusion, reached from either gameplay page's game-ended hand-off.
            Routing.RegisterRoute(ShellOutcomeNavigator.OutcomeRoute, typeof(OutcomePage));
