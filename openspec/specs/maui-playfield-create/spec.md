# maui-playfield-create Specification

## Purpose
Enable a user to create a new playfield from the MAUI app's Private tab by naming it, choosing its visibility, defining its area, and submitting it to the backend.
