...
The Prey is a GPS-based hide-and-seek game played in a defined outdoor area called a **playfield**. One or more players are **Prey**, who hide and evade. Exactly one player is the **Hunter**, who tracks and tags.
...
|---|---|---|
| Head Start | 5 minutes | Prey scatter and hide. The Hunter is held in place, with no moving and no tagging yet. |
