...
2. If you are **Prey**: the head start countdown is on screen. Move immediately. Do not wait for hunters to appear — they start tracking as soon as the head start ends.
...
5. As **Prey**: the map shows Hunter positions so you know which direction to avoid. Keep moving. Pinned positions are not real-time — assume Hunters are closer than the map shows.
